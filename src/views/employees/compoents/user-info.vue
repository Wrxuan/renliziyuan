    ...
    <el-form label-width="220px">
      <div class="block">
        ...
        <el-form-item label="员工照片">
          <!-- 放置上传图片 -->
          <UploadImg ref="employeesPic" :default-url="employeespic" @on-success="uploadAvatarpic" />
        </el-form-item>
      ...
      <div class="block">
        ...
        <el-row class="inline-info" type="flex" justify="center">
          <el-col :span="12">
            <el-button type="primary" @click="saveEmpoyeesInfo">保存更新</el-button>
            <el-button @click="$router.back()">返回</el-button>
          </el-col>
        </el-row>
      </div>
...
import { getUserDetailById, getEmpoyeesInfo, saveUserDetailById } from '@/api/user'
import { saveEmpoyeesInfo } from '@/api/employees'
export default {
  data() {
    return {
  ...
  methods: {
    ...
    async loadEmployees() {
      const res = await getEmpoyeesInfo(this.userId)
      if (res.staffPhoto) {
